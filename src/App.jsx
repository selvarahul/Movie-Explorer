...
import NotFound from "./NotFound"; // moved to components folder in this example
...
function App() {
  ...
  // IMPORTANT: pass basename into createBrowserRouter options
  const basename = import.meta.env.PROD ? "/Movie-Explorer" : "/";
  ...
  const router = createBrowserRouter(
    ...
    { basename } // <--- this is required when using createBrowserRouter
  );
